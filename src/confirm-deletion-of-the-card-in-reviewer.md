...
❓️Confirm deletion of the card in Reviewer (Fixed by Shigeඞ)

**[AnkiWeb Page](https://ankiweb.net/shared/info/354810378) | Code : `354810378`**
...
Show a pop-up before deleting a note in Reviewer to prevent accidental deletion.

This add-on is a fixed and customized version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/263363568" target="_blank">"confirm deletion"</a>, originally created by <a href="https://github.com/ijgnd" target="_blank">ijgnd </a> and credit goes to them.
...
* This add-on only works with Reviewer for now, not the browser.
* This add-on is relatively fragile, so if it doesn't work fine, please contact me.
...
```
2025-10-20:
- New alternative functions developed to avoid errors.
- Add option UI.
- Update License info.
...
2. Copy and paste the add-on code ( `354810378` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/354810378)
