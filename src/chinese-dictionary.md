...
🐼Chinese Dictionary CC-CEDICT (Fixed by Shigeඞ)
https://ankiweb.net/shared/info/1563780834
 -->
...
This add-on allows you to search the [CC-CEDICT dictionary](https://cc-cedict.org/wiki/) and auto add cards to your decks. Number of entries in the dictionary: 120,416

This add-on is a fixed version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/418828045" target="_blank">"CC-CEDICT for Anki (Chinese dictionary)
"</a>, originally created by <a href="https://github.com/ThoreBor" target="_blank">Thore Tyborski</a> and credit goes to them.

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/chinese-dictionary/00.png)



## How to use

Tools -> Chinese dictionary launches the add-on window (Ctrl+D). After selecting a word, add it to your deck using the Add card option in the lower-right corner.
* Settings are automatically saved.
* Search for multiple words at once (separated by a comma).
* Detections for input (Simplified, Traditional, or English)
* Option to color pinyin.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/1563780834" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `1563780834` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/1563780834)
