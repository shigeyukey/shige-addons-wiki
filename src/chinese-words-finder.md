...
Hi I'm add-ons developer Shige, I fixed this add-on and uploaded it to AnkiWeb.
 🐼Chinese Words Finder (Fixed by Shigeඞ)
https://ankiweb.net/shared/info/1259610887
 -->
...
This add-on finds all Chinese words in the [CC-CEDICT dictionary](https://cc-cedict.org/wiki/start) that only use the characters in the decks you select (sorted by frequency), missing HSK words and analyzes the frequency of characters.

This add-on is a fixed version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/2048169015" target="_blank">"Chinese Words Finder"</a>, originally created by <a href="https://github.com/ThoreBor" target="_blank">Thore Tyborski</a> and credit goes to them.

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/chinese-words-finder/00.png)
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/1259610887" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `1259610887` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/1259610887)
