...
\[💡New ] Added function to show the current card deck or tag Pokemon in the toolbar during review.<br>
![alt text](images/pokemanki/01.png)<br>
If distracting you can optionally hide it.<br>
![alt text](images/pokemanki/02.png)<br>
<br>
