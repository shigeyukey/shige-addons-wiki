...
Add a search box to the editor and reviewer.

This add-on is a Fixed and Enhanced version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/1251668918" target="_blank">"Search Bar
...
* Type in the text and press Enter to search.
* Press Shift+Enter to return to the previous text.
* The Browse Editor interferes with keys, so use Ctrl+Alt+Shift+F instead.
* Click the 🔍️ button in the editor to show or hide the search bar.
...
* This option can toggle the search bar to be displayed by default or not. The reviewer is disabled by default.

#### Shorcut

* You can set shortcut keys to show or hide the search bar.
* If the shortcut key is the same as Anki or other add-ons it will not work, if so try changing it to another key.

#### Search Mode

There are two types of search ways, Webview(Qt) and JavaScript.
...
#### Q. How is this different from Anki's default search?

* The default search in Browse searches all cards, this add-on searches only the text within a card, so it is useful when a card contains long text.


#### Q. Why aren't the shortcut keys working?
*  If the keys interfere with other add-ons, they will not work, Browse has many functions so it is prone to interference. If so please try changing the options to different shortcut keys.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/342408518" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `342408518` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/342408518)