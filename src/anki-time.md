...
**[AnkiWeb Page](https://ankiweb.net/shared/info/2142212962) | Code : `2142212962`**
...
If you stay away from Anki for some time(30s), a distracting alarm sounds.

This add-on is a fixed version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/998250600" target="_blank">"Anki Time (anti-distraction helper)"</a>, originally created by <a href="https://github.com/phu54321" target="_blank">Hyun Woo Park (trgk_anki)</a> and credit goes to them.
...
After installing the add-on, it will activate automatically. If left idle for over 30 seconds in Reviewer an alarm will sound. You can change the timer duration and sound in the Config.

## Note

* There is a reported issue where the original add-on does not work fine on some devices. This issue is still under looking into and remains unresolved, please wait.
* This fixed version has simplified functionality to make it work and only supports Anki for desktop.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/2142212962" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `2142212962` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/2142212962)
