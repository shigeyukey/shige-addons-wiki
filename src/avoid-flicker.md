# ❄️Avoid Flicker (Created by Shigeඞ)

**[AnkiWeb Page](https://ankiweb.net/shared/info/155773558) | Code : `155773558`**


<!-- ❄️Avoid Flicker - Freeze Anki's UI for 500 milliseconds (Created by Shigeඞ)
...
* The add-on will be auto enabled after installation.
...
You can change the duration in the add-on's Config.
...
If this happens please launch Anki in safe mode and disable the add-on.

* How to Launch Anki in Safe Mode
  1. Close Anki. (or restart the PC, or use Task manager)
  2. Launch Anki while holding down the Shift key.
  3. Anki will launch with all add-ons disabled.
      * (If it doesn't you may have released the Shift key too soon so please try again.)
  4. Disable or remove the add-on.
  5. Restart Anki.
...
* addon: [🏃🏻No Space Dash-Prevents answer for 1.5 seconds](https://ankiweb.net/shared/info/1573867049)
...
2. Copy and paste the add-on code ( `155773558` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/155773558)
