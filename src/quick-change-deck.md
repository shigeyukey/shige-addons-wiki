...
![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/quick-change-deck/07.png)
...
You don't need to restart Anki after changing settings, but if you already open the Reviewer and Browser you need to close them and reopen them (maybe).
...
```
2025-10-23
[1] First release (Fixed and Enhanced)
- Extract add-on code from Anki 2.0
- Upgrade from PyQt4 to PyQt6
- Update old config saving method to latest version
- Update old hooks to latest version
- Update license info
- Added reviewer support
- Created options window
- Changed actions in the card menu
- Add Option auto popup (initial setup)
```
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/398819226" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
**[[ Special Thanks ]](https://shigeyukey.github.io/shige-addons-wiki/patrons_credit.html#patrons)** <br>
 So far I received donations from 528 patrons and without their support I never could develop this, thank you very much!🙏<br><br>
...
2. Copy and paste the add-on code ( `398819226` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/398819226)
