...
Github: [imageio-ffmpeg](https://github.com/imageio/imageio-ffmpeg)

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/ffmpeg-downloader/01.png)
...
FFmpeg is a free open source software that can convert video and audio.
Some add-ons may require FFmpeg when adding audio or video to cards.
...
Github: [imageio-ffmpeg](https://github.com/imageio/imageio-ffmpeg)<br>
pip: [imageio-ffmpeg](https://pypi.org/project/imageio-ffmpeg/#files)
