...
*Removes non-breaking-spaces (`&nbsp;`) automatically during editing and offers a Tools menu entry to purge your collection.  ̿̿ ̿̿ ̿̿ ̿'̿'\̵͇̿̿\з= ( ▀ ͜͞ʖ▀) =ε/̵͇̿̿/’̿’̿ ̿ ̿̿ ̿̿ ̿̿*

This add-on is a Fixed and Enhanced version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/1676672391" target="_blank">"nbspRemover"</a>, originally created by <a href="https://github.com/kleinerpirat" target="_blank">Matthias Metelka (kleinerpirat)</a> and credit goes to them.

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/nbsp-remover/03.png)

## How to use


* Automatically removes `&nbsp;` after adding a card. (Replaces with space)
* Batch remove `&nbsp;` from all decks from the Add-on menu. (Replaces with space)

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/nbsp-remover/01.png)


### Option

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/nbsp-remover/00.png)
...
#### Auto Run Startup
* When Anki is launched, it autruns a bulkremove from the collection, this function is only run once a day. This option is disabled by default.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/1998029342" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `1998029342` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/1998029342)