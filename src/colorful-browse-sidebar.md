# 🎨Colorful Browse Sidebar

🎨Colorful Browse Sidebar (Fixe by Shigeඞ)

**[AnkiWeb Page](https://ankiweb.net/shared/info/1164332345) | Code : `1164332345`**

<!-- 
Hi I'm add-ons developer Shige, I fixed this add-on and uploaded it to AnkiWeb.
🎨Colorful Browse Sidebar (Fixe by Shigeඞ)"
https://ankiweb.net/shared/info/1164332345
 -->
...
Customize icon colors of everything in the browser sidebar.

This add-on is a fixed version for Anki25+ of the addon <a href="https://ankiweb.net/shared/info/929609616" target="_blank">"Colorful Browser Sidebar"</a>, originally created by <a href="https://github.com/BlueGreenMagick" target="_blank">Yoonchae Lee (BlueGreenMagick)</a> and credit goes to them.


![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/colorful-browse-sidebar/00.png)
...
* The color is remembered using its type and the name. If you rename a browser sidebar item, you will need to set the colors again.
* To reset all colors press the Restore Default button in Config.


## Note

* The original add-on caused Anki to crash. This version has already fixed that problem, but if you encounter a similar problem, please contact me.
* There is no function to change the text color.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/1164332345" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `1164332345` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/1164332345)
