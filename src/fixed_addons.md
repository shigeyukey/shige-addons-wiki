...
- [🛠️Fix Broken Anki Add-ons for latest Anki by Shigeඞ](#️fix-broken-anki-add-ons-for-latest-anki-by-shigeඞ)
  ...
  - [To fix it, I need to understand how add-on works. If it is very complicated it will take months to read the code little by little.](#to-fix-it-i-need-to-understand-how-add-on-works-if-it-is-very-complicated-it-will-take-months-to-read-the-code-little-by-little)
