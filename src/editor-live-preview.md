...
**[AnkiWeb Page](https://ankiweb.net/shared/info/90407377) | Code : `90407377`**
...
You can show or hide the preview by pressing the button at the top of the editor.

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/editor-live-preview/02.png)

### Option

![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/editor-live-preview/01.png)

### Auto Show

* Auto show or hide the preview when the editor is displayed.

### Split Raito of Editor and Previewer

* You can change the ratio of Editor and Previewer. (e.g. Editor:7, Previewer:3)
...
* The original Editor Live Preview is having problems only with Javascript. HTML and CSS are working well, so this Fork is not necessary if your card template does not include Javascript.
* This fix is relatively simple, the original author seems to be busy but active so this Fork is not needed after the fix and pull request are incorporated.
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/90407377" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
2. Copy and paste the add-on code ( `90407377` )  into Anki and you can install it. ( *Menu -> Tools -> Add-ons -> Get Add-ons -> Code \[ add-on code ]* )
...
[Click here and please Rate this add-on, Thank you! :-) <br>
 ![Please rate this](https://raw.githubusercontent.com/shigeyukey/my_addons/main/media_files/rate_this.gif)](https://ankiweb.net/shared/review/90407377)