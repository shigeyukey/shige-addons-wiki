...
If sound effects do not work you can change the sound system (Anki must be restarted after changing). This option only affects Sound effects, BGM uses a different mechanism (MIDI) and is unaffected. If sounds are already working fine this option is not needed.
