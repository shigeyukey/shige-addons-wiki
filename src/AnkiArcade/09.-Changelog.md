...
* [ AnkiArcade.1.9.3.ankiaddon (file size: 104 MB) ](https://www.patreon.com/posts/ankiarcade-v1-9-136548011) 2025-08-31
  * Tried to fix a bug preventing loading on some device (v2)
  * Enhanced error handling (v2)

* [ AnkiArcade.1.9.2.ankiaddon (file size: 104 MB) ](https://www.patreon.com/posts/ankiarcade-v1-9-136548011) 2025-08-26
  * Tried to fix a bug preventing loading on some device
  * Enhanced error handling

* [ AnkiArcade.1.9.1.ankiaddon (file size: 104 MB) ](https://www.patreon.com/posts/ankiarcade-v1-9-136548011) 2025-08-19
  * Added a patch for the problem of sound not playing on some devices.
  * Enhanced and optimized the sound system.

* [ AnkiArcade.1.9.0.ankiaddon (file size: 104 MB) ](https://www.patreon.com/posts/ankiarcade-v1-9-136548011) 2025-08-15
  * Added 19 new pixel art characters.
  * Added idle animations for enemy monsters.
  * Fixed a bug that caused sound errors in the latest Anki25+.
  * Separated the V-AnkiPad into a another add-on.
  * Changed the Mozartanki icon to pixel art.
  * Added a tomato icon to the Pomodoro timer.
  * Added a function to detect crashes and disable the sound system.
  * Optimized a lot of code.
  * Updated license info.
  * Optimized the size of many images.
  * Added new banner images for some characters.
  * Improved the actions of some characters.
  * Note: The button system Vitual Anki Pad has been made into a separate add-on, so it has been removed from this version of AnkiArcade. addon: [Virtual Anki Pad v1.0.ankiaddon 774KB](https://www.patreon.com/file?h=97422306&m=482659871)



* [AnkiArcade.1.8.5.ankiaddon (file size: 95.5 MB)](https://www.patreon.com/file?h=116494987&m=383603281) 2024-11-26
   * Fixed a position bug and enhanced the functions more.
   * Set font for number of progress bars.
   * The color of the numbers on the progress bar in dark mode is now white.


* [AnkiArcade.1.8.4.ankiaddon (file size: 95.52 MB)](https://www.patreon.com/file?h=116494987&m=383310509) 2024-11-25
  * Fixed display bug.


* [AnkiArcade.1.8.3.ankiaddon (file size: 95.52 MB)](https://www.patreon.com/file?h=116494987&m=383291368) 2024-11-25
  * Enhanced auto adjustment of progress bars position (Beta)
  * Added option to adjust position when there are multiple progress bars
  * Fixed a bug that the icons were not displayed.
  * Fixed a bug that bars' materials were not displayed when progress bar was completed.
  * Fixed farmer normal response action


* [AnkiArcade.1.8.2.ankiaddon](https://www.patreon.com/file?h=116494987&m=382693278) 2024/11/24
   * Added workaround for a bug that causes an error when updating add-ons. If you encounter this problem please download with add-ons disabled: Start Anki with Shift key pressed (all add-ons will be disabled) -> Download AnkiArcade -> Restart Anki
