# Ankimon Patch V2 Installer
🛠️Ankimon Patch V2 Installer - Fix Patch for Ankimon (Fixed by Shigeඞ)


<!-- 
Hi I'm add-ons developer Shige, I fixed this add-on and uploaded it to AnkiWeb.
🛠️Ankimon Patch V2 Installer - Fix Patch for Ankimon (Fixed by Shigeඞ)
https://ankiweb.net/shared/info/1947038262

I developed and released a new version of the patch to fix a bug that prevented the patch from working for some users, if it does not work please contact me again.
🛠️Ankimon Patch V2 Installer - Fix Patch for Ankimon (Fixed by Shigeඞ)
https://ankiweb.net/shared/info/1947038262
...
**[AnkiWeb Page](https://ankiweb.net/shared/info/1947038262) | Code : `1947038262`**
...
Adds a temporary patch V2 and fixes to make broken Ankimon work with the latest Anki 25.07+. This V2 of the patch fixes a bug that only occurs for new Ankimon users. This patch does not change Ankimon's code or data so it will not affect your Ankimon data. If your Ankimon is already working this patch is not necessary.
...
* Once the installation is successful the main patch will be generated. In short there will be two add-ons for Patch V2, which is normal and not a duplicate. Like this:
  * ![alt text](https://shigeyukey.github.io/shige-addons-wiki/images/ankimon-patch-v2/00.png)

#### Q. Why are there two patch add-ons?

* To apply the patch we need to install the add-on before Ankimon, but this is not possible with a normal add-on so it is separated into a different add-on, and this add-on alone cannot update the patch, so there are two add-ons the installer and the main.
...
* Once Ankimon has been repaired and updated, this add-on will no longer be necessary. Also this patch does not change Ankimon's code or data, so if you disable or delete the add-on it will be restored to its original state. (the Module added by the Launcher will remain even after the Add-on is deleted but it will be deleted when you update Anki.)
...
If you have any problems or requests feel free to send them to me.
  ...
  1. <a href="https://ankiweb.net/shared/review/1947038262" target="_blank">👍️Rate Comment</a> : You can contact me anonymously, and AnkiWeb will send you an email when I reply, a high rating increases priority of development.
...
**[[ Special Thanks ]](https://shigeyukey.github.io/shige-addons-wiki/patrons_credit.html#patrons)** <br>
 So far I received donations from 462 patrons and without their support I never could develop this, thank you very much!🙏<br><br>
